		...
		<div id="show-client" class="content scaffold-show" role="main">
			...
			<ol class="property-list client">
				...
				<li class="fieldcontain">
					<span id="clientCode-label" class="property-label"><g:message code="client.clientCode.label" default="Client Code" /></span>
					
						<span class="property-value" aria-labelledby="clientCode-label"><g:fieldValue bean="${clientInstance}" field="clientCode"/></span>
				...
				<li class="fieldcontain">
					<span id="clientName-label" class="property-label"><g:message code="client.clientName.label" default="Client Name" /></span>
